...
import { ClaimantName, ValidationErrors } from 'app/forms/models/claimantName'
import * as randomstring from 'randomstring'

describe('Claimant Details', () => {
  describe('deserialize', () => {
    it('should return an instance', () => {
      let deserialized = new ClaimantName().deserialize({})
      expect(deserialized).to.be.instanceof(ClaimantName)
    })

    it('should return an instance initialised with defaults for "undefined"', () => {
      expect(new ClaimantName().deserialize(undefined)).to.eql(new ClaimantName())
    })

    it('should return an instance initialised with defaults for "null"', () => {
      expect(new ClaimantName().deserialize(null)).to.eql(new ClaimantName())
    })
    ...
    it('should return am instance from given object', () => {
      ...
      expect(deserialized).to.eql(new ClaimantName(ClaimantTypes.INDIVIDUAL, 'title', 'full name', undefined, undefined))
    })
  })
  ...
  describe('validation', () => {
    ...
    it('should reject claimant details for undefined type', () => {
      const errors = validator.validateSync(new ClaimantName(undefined))
    ...
    it('should accept claimant details for claimant type when individual details are valid', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.INDIVIDUAL, 'title', 'full name', undefined, undefined))
    ...
    it('should reject claimant details for claimant type when individual details are undefined', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.INDIVIDUAL, undefined, undefined, undefined, undefined))
    ...
    it('should reject claimant details for claimant type when individual details are null', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.INDIVIDUAL, null, null, undefined, undefined))
    ...
    it('should reject claimant details for claimant type when individual details are empty', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.INDIVIDUAL, '', '', undefined, undefined))
    ...
    it('should accept claimant details for organisation type when organisation details are valid', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.ORGANISATION, undefined, undefined, 'organisation name', '12345678'))
    ...
    it('should reject claimant details for organisation type when organisation name is null', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.ORGANISATION, undefined, undefined, null, '12345678'))
    ...
    it('should reject claimant details for organisation type when organisation name is undefined', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.ORGANISATION, undefined, undefined, undefined, '12345678'))
    ...
    it('should reject claimant details for organisation type when organisation name length is more than 255', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.ORGANISATION,
    ...
    it('should reject claimant details for claimant type when full name length is more than 70', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.INDIVIDUAL,
    ...
    it('should accept claimant details for claimant type when value length is 70', () => {
      ClaimantTypes.all().forEach(type => {
        const errors = validator.validateSync(new ClaimantName(ClaimantTypes.INDIVIDUAL,
  ...
  describe('fromObject', () => {
    ...
    it('should have claimant details elements undefined when input is undefined', () => {
      const claimantDetails = ClaimantName.fromObject(undefined)

      expect(claimantDetails.type).to.equal(undefined)
      expect(claimantDetails.title).to.equal(undefined)
      expect(claimantDetails.value).to.equal(undefined)
    ...
    it('should have claimant details elements undefined when input has undefined element value', () => {
      const claimantDetails = ClaimantName.fromObject({
        type: undefined,
        title: undefined,
        fullName: undefined,
        organisation: undefined,
    ...
    it('should have valid claimant details elements', () => {
      ...
      expect(claimantDetails.value).to.equal('full name')
      expect(claimantDetails.organisation).to.equal(undefined)
      expect(claimantDetails.companyHouseNumber).to.equal(undefined)
    })
  })
