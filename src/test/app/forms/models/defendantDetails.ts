...
describe('Defendant Details', () => {
  describe('deserialize', () => {
    ...
    it('should return am instance from given object', () => {
      ...
      expect(deserialized).to.eql(new DefendantDetails(IndividualTypes.INDIVIDUAL, 'title', 'full name', undefined, undefined))
    })
  })
  ...
  describe('validation', () => {
    ...
    it('should accept defendant details for individual type when individual details are valid', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.INDIVIDUAL, 'title', 'full name', undefined, undefined))
    ...
    it('should reject defendant details for individual type when individual details are undefined', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.INDIVIDUAL, undefined, undefined, undefined, undefined))
    ...
    it('should reject defendant details for individual type when individual details are null', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.INDIVIDUAL, null, null, undefined, undefined))
    ...
    it('should reject defendant details for individual type when individual details are null', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.INDIVIDUAL, '', '', undefined, undefined))
    ...
    it('should accept defendant details for organisation type when organisation details are valid', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.ORGANISATION, undefined, undefined, 'organisation name', '12345678'))
    ...
    it('should reject defendant details for organisation type when organisation name is null', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.ORGANISATION, undefined, undefined, null, '12345678'))
    ...
    it('should reject defendant details for organisation type when organisation name is undefined', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.ORGANISATION, undefined, undefined, undefined, '12345678'))
    ...
    it('should reject defendant details for organisation type when organisation name length is more than 255', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.ORGANISATION,
    ...
    it('should reject defendant details for individual type when full name length is more than 70', () => {
      IndividualTypes.all().forEach(type => {
        const errors = validator.validateSync(new DefendantDetails(IndividualTypes.INDIVIDUAL,
  ...
  describe('fromObject', () => {
    ...
    it('should have valid defendant details elements', () => {
      ...
      expect(defendantDetails.type).to.eql(IndividualTypes.INDIVIDUAL)
