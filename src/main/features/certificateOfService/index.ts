...
export class Feature {
  enableFor (app: express.Express) {
    ...
    app.all(/^\/legal\/certificateOfService\/document-upload$/, DraftMiddleware.requestHandler<DraftUploadDocument>('legalUploadDocument',
      (value: any): DraftUploadDocument => {
